  ...
  render() {
    return (
      <div className="header-margin">
        <h2>X by 2, LLC Privacy Policy</h2>

        <h3>1. Terms</h3>

        <p>
          By accessing the website at{" "}
          <a href="http://xby2.com">http://xby2.com</a>, you are agreeing to be
        ...
        <ol type="a">
          <li>
            ...
            materials (information or software) on X by 2, LLC's website for
          ...
          <li>
            ...
            these restrictions and may be terminated by X by 2, LLC at any time.
        ...
        <ol type="a">
          <li>
            The materials on X by 2, LLC's website are provided on an 'as is'
            basis. X by 2, LLC makes no warranties, expressed or implied, and
          ...
          <li>
            Further, X by 2, LLC does not warrant or make any representations
        ...
        <p>
          In no event shall X by 2, LLC or its suppliers be liable for any
          damages (including, without limitation, damages for loss of data or
          profit, or due to business interruption) arising out of the use or
          inability to use the materials on X by 2, LLC's website, even if X by
          2, LLC or a X by 2, LLC authorized representative has been notified
        ...
        <p>
          The materials appearing on X by 2, LLC's website could include
          technical, typographical, or photographic errors. X by 2, LLC does not
          warrant that any of the materials on its website are accurate,
          complete or current. X by 2, LLC may make changes to the materials
          contained on its website at any time without notice. However X by 2,
        ...
        <p>
          X by 2, LLC has not reviewed all of the sites linked to its website
          and is not responsible for the contents of any such linked site. The
          inclusion of any link does not imply endorsement by X by 2, LLC of the
        ...
        <p>
          X by 2, LLC may revise these terms of service for its website at any
        ...
        <p>
          ...
          with the laws of MI and you irrevocably submit to the exclusive
        ...
        <p>
          It is X by 2, LLC's policy to respect your privacy regarding any
        ...
        <p>
          ...
          information is protected and maintained. X by 2, LLC may change this
          privacy policy from time to time at X by 2, LLC's sole discretion.
        </p>
      </div>
    );
  }
